...
class MyDayDecorator2(val context: Context) : DayViewDecorator {
    private var selectedDay: List<CalendarDay> = arrayListOf()

    private var drawable2: Drawable = context.resources.getDrawable(R.drawable.bg_absence_khong_phep)
